...
{
    /// <inheritdoc />
    public partial class AddLanguagesAndSeeding : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SupportedLanguagesCode = table.Column<string>(type: "character varying(50)", nullable: false),
                    TenantsId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LanguageTenant", x => new { x.SupportedLanguagesCode, x.TenantsId });
                    table.ForeignKey(
                        name: "FK_LanguageTenant_Languages_SupportedLanguagesCode",
                        column: x => x.SupportedLanguagesCode,
                        principalTable: "Languages",
                        principalColumn: "Code",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LanguageTenant_Tenants_TenantsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LanguageTenant_TenantsId",
                table: "LanguageTenant",
                column: "TenantsId");
        }
