...
export default function ChatInterface({ chatbotId, language = 'en' }) {
    ...
    return (_jsxs("div", { className: "modal-chat-container", children: [_jsx("div", { className: "modal-messages-container", children: messages.length === 0 ? (_jsxs("div", { className: "modal-welcome-screen", children: [_jsx("div", { className: "centered-logo", children: _jsx("div", { className: "logo-circle", children: _jsx("img", { src: "https://hattieai.touchpointe.digital/hattie.png", alt: "Logo", style: {
                                        width: '100%',
                                        height: 'auto',
                                        objectFit: 'contain'
                                    } }) }) }), _jsx("div", { className: "today-divider", children: _jsx("span", { children: t.today }) }), _jsxs("div", { className: "welcome-message-container", style: { direction: language === 'ar' ? 'rtl' : 'ltr' }, children: [_jsx("div", { className: "bot-avatar-small", children: _jsx("img", { src: "https://hattieai.touchpointe.digital/hattie.png", alt: "Bot", style: {
                                            width: '28px',
                                            height: 'auto',
                                            objectFit: 'contain'
                                        } }) }), _jsxs("div", { className: "welcome-message-content", children: [_jsx("h3", { className: "welcome-greeting", children: t.greeting }), _jsx("p", { className: "welcome-description", children: tenantName ? `${tenantName} AI Assistant` : 'AI Assistant' })] })] })] })) : (_jsxs(_Fragment, { children: [messages.map((msg, index) => (_jsxs("div", { className: `chat-message ${msg.role}`, children: [msg.role === 'assistant' && (_jsx("div", { className: "chat-avatar bot-avatar", children: _jsx("img", { src: "https://hattieai.touchpointe.digital/hattie.png", alt: "Bot" }) })), _jsx("div", { className: `chat-bubble ${msg.role}`, children: msg.content })] }, index))), loading && (_jsxs("div", { className: "chat-message assistant", children: [_jsx("div", { className: "chat-avatar bot-avatar", children: _jsx("img", { src: "https://hattieai.touchpointe.digital/hattie.png", alt: "Bot" }) }), _jsx("div", { className: "chat-bubble assistant", children: _jsxs("div", { className: "typing-indicator", children: [_jsx("div", { className: "typing-dot" }), _jsx("div", { className: "typing-dot" }), _jsx("div", { className: "typing-dot" })] }) })] })), _jsx("div", { ref: messagesEndRef })] })) }), _jsx("div", { className: "modal-input-container", style: { direction: language === 'ar' ? 'rtl' : 'ltr' }, children: _jsxs("div", { className: "modal-input-wrapper", children: [_jsx("input", { type: "text", className: "modal-message-input", value: input, onChange: (e) => setInput(e.target.value), onKeyDown: handleKeyDown, placeholder: t.placeholder, disabled: loading, style: { textAlign: language === 'ar' ? 'right' : 'left' } }), _jsx("button", { className: "modal-send-button", onClick: handleSend, disabled: !input.trim() || loading, "aria-label": "Send message", children: _jsx("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "currentColor", children: _jsx("path", { d: "M10 3L10 17M10 3L4 9M10 3L16 9", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", fill: "none" }) }) })] }) })] }));
}
